...
2. اسحب `hajimi.app` إلى مجلد `Applications`.
3. افتح hajimi من مجلد `Applications`.

النسخة الحالية من macOS موقّعة بتوقيع ad-hoc ولم توثّقها Apple بعد. إذا منع macOS تشغيل التطبيق، افتحه مرة واحدة، ثم انتقل إلى **إعدادات النظام ← الخصوصية والأمان ← فتح على أي حال** وأكّد رغبتك في فتحه. استخدم ذلك فقط مع ملف DMG الذي نزّلته من إصدار hajimi الرسمي على GitHub.

وكحل بديل عبر سطر الأوامر، وبعد نقل التطبيق إلى `Applications`، يمكنك إزالة سمة العزل الخاصة بالتنزيل:
