...
hajimi foi construído sobre a base do [Cardinal](https://github.com/cardisoft/cardinal). Agradecemos sinceramente aos autores e colaboradores do projeto original pela inspiração e pelo trabalho fundamental.
